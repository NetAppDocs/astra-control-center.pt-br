...
+
** Para clusters GKE, Astra Control Service usa  https://www.netapp.com/google-cloud/netapp-volumes/["NetApp Cloud Volumes Service para Google Cloud"^] ou Google Persistent Disks como backend de armazenamento para seus volumes persistentes.
** Para clusters AKS, Astra Control Service usa  https://www.netapp.com/azure/azure-netapp-files/["Azure NetApp Files"^] ou discos gerenciados pelo Azure como backend de armazenamento para seus volumes persistentes.
