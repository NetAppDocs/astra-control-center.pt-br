...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.13/html/installing_on_google_cloud/index["Instalação de um cluster OpenShift no GCP"^]
