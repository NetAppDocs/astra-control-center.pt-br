...
.Antes de começar
* Certifique-se de que você está link:../get-started/enable-acp.html["Ativou o Astra Control Provisioner"]no cluster gerenciado.
...
.Antes de começar
* Certifique-se de que você ativou o Astra Control Provisioner no cluster gerenciado do Red Hat OpenShift. link:../get-started/enable-acp.html["Habilite o Astra Control Provisioner"]Consulte para obter instruções.
* Certifique-se de que tem acesso ao `tridentctl` utilitário.
