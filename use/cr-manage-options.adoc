...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource["Definir uma aplicação usando um recurso personalizado do Kubernetes"]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource["Gerencie um bucket usando um recurso personalizado"]
